...
//                "}";
//        ObjectMapper objectMapper = new ObjectMapper();
//        List<PaymentMethod> methods = objectMapper.readValue(json, List.class);
//
//        assertNotNull(methods);
//        assertEquals(2, methods.size());
//        assertEquals("PUNKTY", methods.get(0).getID());
//        assertEquals("mZysk", methods.get(1).getID());
//        assertEquals(BigDecimal.valueOf(100.00), methods.get(0).getLimit());
...
//        assertEquals(BigDecimal.valueOf(180.00), methods.get(1).getLimit());
